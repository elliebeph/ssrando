...
ET_ENTRANCE = "Dungeon Entrance in Lake Floria"
LMF_ENTRANCE = "Dungeon Entrance in Eldin Volcano"
AC_ENTRANCE = "Dungeon Entrance in Volcano Summit"
SSH_ENTRANCE = "Dungeon Entrance in Lanayru Desert"
FS_ENTRANCE = "Dungeon Entrance in Sand Sea"
